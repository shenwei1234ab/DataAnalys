...
LEFT JOIN  channelLabel_lj ON account.channelLabel = channelLabel_lj.channelLabel)as account 
    ...
    /// <summary>
    /// 执行sqlcommand,返回sql执行的结果###############替换GetAggregateResult函数
    /// </summary>
    /// <param name="cmd">sqlcommand枚举指令</param>
    /// <param name="resultTB">输出参数</param>
    /// <param name="parsArray">绑定参数（可变参数列表）</param>
    ...
    /// </summary>
    /// <param name="cmd">sqlcommand枚举指令</param>
    /// <param name="resultName">结果名称</param>
